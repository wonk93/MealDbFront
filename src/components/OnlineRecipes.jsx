        ...
        <article>
            ...
            <Form>
                <Form.Group className="mb-3" controlId="home-recipe-form">
                    <Form.Label>Busca recetas online por nombre o una aleatoria:</Form.Label><br />
                    <div className="input-group">
                        ...
                        <div className="input-group-append">
                            <ButtonGroup aria-label="home-recipe-form">
                                ...
                                <Button variant="success" onClick={navigateToRandomOnlineRecipe}>Receta aleatoria</Button>
                            </ButtonGroup>
                        </div>
                    </div>
                </Form.Group>
